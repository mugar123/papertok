async function testProxy() {
  ...
  const query = `"Dynamics & Robotics" OR "Fluid Mechanics" OR "Thermodynamics" OR "Solid Mechanics" OR "Aerospace Engineering" OR "Manufacturing"`;
  ...
  try {
    ...
    if (text.length < 500) {
      ...
      console.log("Success with 6 categories on allorigins!");
    }
  } catch (e) {
